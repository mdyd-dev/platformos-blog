webpackJsonp(
  ...
  [
    ...
    function (module, exports, __webpack_require__) {
      ...
      !(function (e, t) {
        'object' === (false ? 'undefined' : _typeof(exports)) && 'undefined' != typeof module
          ? (module.exports = t())
          : true
        ...
        var e = {
          ...
          v = function (e, t) {
            u(t.callback_enter, e),
              ['IMG', 'IFRAME'].indexOf(e.tagName) > -1 && (f(e, t), c(e, t.class_loading)),
              a(e, t),
              n(e, 'was-processed', !0),
              u(t.callback_set, e);
          },
    ...
    function (module, exports, __webpack_require__) {
      ...
      (function ($) {
        ...
        $(function () {
          new _vanillaLazyload.default({ elements_selector: '[data-lazy-load]' });
        });
    ...
    function (module, exports, __webpack_require__) {
      ...
      (function ($) {
        ...
        var formatValue = function formatValue(value) {
          ...
          var clientDate = new Date(value + 'T00:00:00+00:00');
          var formattedDate = formatDate(clientDate);
          $(SELECTOR_SERVER).val(formattedDate);
          console.info(
            'Serving '.concat(formattedDate, ' to the server from user input: ').concat(value)
          );
        };
